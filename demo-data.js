window.ASSET_DEMO = (() => {
  ...
  const assets = [
    {id:1,tag:"AST-1001",hostname:"FIN-LT-014",type:"Laptop",serial:"LNV-83F4A2",status:"Assigned",owner_id:1,owner:"Adrian Reyes",department:"Finance",location:"Main Office",purchase_date:"2025-01-16",warranty_expiry:days(118),updated_at:ago(.2),specs:{CPU:"Intel Core i5-1345U",RAM:"16 GB",Storage:"512 GB NVMe",OS:"Windows 11 Pro"}},
    ...
    {id:3,tag:"AST-1003",hostname:"HR-LT-008",type:"Laptop",serial:"HP-19A8D1",status:"Assigned",owner_id:3,owner:"Nico Cruz",department:"Human Resources",location:"Main Office",purchase_date:"2024-04-22",warranty_expiry:days(-12),updated_at:ago(2),specs:{CPU:"AMD Ryzen 7 7840U",RAM:"16 GB",Storage:"512 GB SSD",OS:"Windows 11 Pro"}},
    ...
    {id:10,tag:"AST-1010",hostname:"MKT-LT-012",type:"Laptop",serial:"LEN-12MKT9",status:"Assigned",owner_id:5,owner:"Miguel Torres",department:"Marketing",location:"Main Office",purchase_date:"2025-03-02",warranty_expiry:days(350),updated_at:ago(2),specs:{CPU:"Intel Core i7-1360P",RAM:"16 GB",Storage:"1 TB SSD",OS:"Windows 11 Pro"}},
