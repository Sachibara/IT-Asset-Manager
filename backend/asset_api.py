...
def seed(conn: sqlite3.Connection) -> None:
    if not conn.execute("SELECT 1 FROM people LIMIT 1").fetchone():
        conn.executemany(
            ...
            [
                (1,"Adrian Reyes","Finance","adrian.reyes@contoso.local","Main Office"),
                (2,"Marco Santos","Operations","marco.santos@contoso.local","Main Office"),
                (3,"Nico Cruz","Human Resources","nico.cruz@contoso.local","Main Office"),
                (4,"Daniel Lee","Sales","daniel.lee@contoso.local","Branch Office"),
                (5,"Miguel Torres","Marketing","miguel.torres@contoso.local","Main Office"),
